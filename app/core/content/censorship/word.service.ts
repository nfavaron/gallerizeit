import { ContentCensorshipInterface } from '../censorship.interface';
import { Injectable } from '@angular/core';

@Injectable()
export class CoreContentCensorshipWordService implements ContentCensorshipInterface {

  /**
   * List of blacklisted words, welcome to the worst of the Web...
   */
  ...
  isSafe(text: string): boolean {
    ...
    while (isSafe === true && (word = words.pop())) {
