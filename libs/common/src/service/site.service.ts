...
import { FirebaseSiteInterface } from '../shared/firebase/site.interface';
...
export class SiteService {
   ...
   * @param data
   */
  private getSiteModel(data: FirebaseSiteInterface): SiteModel {
   ...
   * @param site
   */
  private getSiteFirebase(site: SiteModel): FirebaseSiteInterface {
